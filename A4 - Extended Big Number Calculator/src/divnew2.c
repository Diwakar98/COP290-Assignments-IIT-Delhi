...
char* divnew(char a[],char b[]){
     ...
     for(p=sizeb; p<sizea; p++){
          k=0;
          int lenp=strlen(temp3)+strlen(c);
          // printf("%d\n",quocounter);
          char* temp4 = (char*)malloc(lenp*sizeof(char));
          printf("$$$$$$$$\n");
          while(temp3[0]!='-'){
          ...
          char* temp5 = (char*)malloc(lenp*sizeof(char));
          // printf("Y=%s %s \n",c,temp3);
     ...
     finalans[i]='\0';
     printf("final=%s\n", finalans);
     int len1=strlen(finalans);
     char * ultimateresult=(char*)malloc(len1*sizeof(char));
     i=0;
     while(finalans[i]=='0'){
          i++;
     }
     ...
     ultimateresult[k]='\0';
     char* ultimateans=(char*)malloc(len1*sizeof(char));;
     if(finalsign==false){
          // printf("^^\n");
          ultimateans[0]='-';
          // printf("^^\n");
