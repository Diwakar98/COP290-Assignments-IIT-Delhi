...
{
      13,     0,    -1,    14,     5,    13,    -1,    14,     5,    -1,
      15,    -1,    15,    15,     4,    -1,    15,    15,    -1,     3,
      -1
};
...
{
  "$end", "error", "$undefined", "NUM", "OP", "NEWLINE", "'+'", "'-'",
  "'*'", "'/'", "UMINUS", "'^'", "$accept", "Z", "S", "E", 0
};
#endif
